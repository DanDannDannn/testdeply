...
const BATCHES = [
  ...
  { id: "B-2026-02",  label: "Feb 2026 utility CSV",   source: "csv",     date: "2026-03-04", uploadedBy: "Johannes Weber", fileName: "edf_feb_2026.csv" },
...
ENTRIES.forEach(e => {
  ...
  e.bulk_import_ref = b?.source === "csv" ? b.fileName : (b?.source === "erp" ? b.id : "—");
